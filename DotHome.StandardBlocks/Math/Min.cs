...
namespace DotHome.StandardBlocks.Math
{
    ...
    public class Min : Block
    {
        ...
        {
            double val = System.Math.Min(I1.Value, I2.Value);
            if (!I3.Disabled) val = System.Math.Min(val, I3.Value);
            if (!I4.Disabled) val = System.Math.Min(val, I4.Value);
            O.Value = val;
        }
    }
}
